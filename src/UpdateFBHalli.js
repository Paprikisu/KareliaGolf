...
// Tämä funktio päivittää firestoren sisahallitaulukon täysin vapaaksi varauksista -- Kutsutaan accountmngpg:lla

const weeklyHalliUpdate = () => {
    let collection = db.collection("Sisahallitaulukko")
